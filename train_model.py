...
# print("[INFO] compiling LeNet model...")
# model = LeNet.build(width=28, height=28, depth=1, classes=2)
# model.compile(loss="binary_crossentropy", optimizer="adam",
# 	metrics=["accuracy"])
print("[INFO] compiling MiniVGGNet model...")
model = MiniVGGNet.build(width=28, height=28, depth=1, classes=2)
model.compile(loss="binary_crossentropy", optimizer="adam",
	metrics=["accuracy"])

# construct the set of callbacks used to monitor training performance
outputdir = os.path.dirname("output/lenet.hdf5")
figPath = os.path.sep.join([outputdir, "{}.png".format(os.getpid())])
