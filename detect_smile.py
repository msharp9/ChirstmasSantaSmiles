...
santa = cv2.imread("santa_face.png")
santasmiles = cv2.imread("santa_smiling.png")
...
while True:
	...
	for (fX, fY, fW, fH) in rects:
		...
		if label == "Smiling":
			santaresize = cv2.resize(santasmiles.copy(), (fW,fH))
		else:
			santaresize = cv2.resize(santa.copy(), (fW,fH))
		# santaresize = cv2.resize(santaresize, (0,0), fx=1.5, fy=1.5)
